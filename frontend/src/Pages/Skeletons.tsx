    ...
    return (
        ...
        <section className={`${shimmer} relative overflow-hidden rounded-xl bg-zinc-200 p-2 shadow-sm`}>
            ...
            <div className="flex flex-col justify-center gap-3">
                <span className="flex justify-between items-center"><span className="bg-zinc-100 rounded-md h-5 w-32"></span><span className="bg-zinc-100 rounded-md h-5 w-16"></span></span>
                <span className="flex justify-between items-center"><span className="bg-zinc-100 rounded-md h-5 w-32"></span><span className="bg-zinc-100 rounded-md h-5 w-16"></span> </span>
            </div>

            <DividerSkeleton />
            <div className="flex flex-col gap-6">
                <span className="text-xl bg-zinc-100 rounded-md h-5 w-16"></span>
                <section className="flex justify-between items-center">
                    <div className="flex gap-6 items-center">
                        <span className="bg-zinc-100 rounded-full h-12 w-12"></span>
