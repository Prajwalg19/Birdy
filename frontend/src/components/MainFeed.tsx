                            ...
                            <section className="flex items-center justify-between">
                                <span className="flex items-center gap-4">
                                    ...
                                    <span className="flex flex-col justify-center">
                                        <p><span className="font-semibold capitalize">{post?.firstName + " " + post?.lastName}</span> <span className="p-1">&middot;</span> <span className="font-medium text-sm">{post.createdAt}</span></p>
