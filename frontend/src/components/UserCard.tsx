...
export default function UserCard({userId}: {userId: string | null}) {
    ...
    return (
        userInfo && (
            <div className="dark:border-slate-600 dark:bg-gray-900 dark:text-slate-200 text-black flex flex-col justify-center w-full bg-white rounded-2xl  border border-black/10 h-[520px] shadow-lg px-10" >
